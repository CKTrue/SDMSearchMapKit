...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    kWeakSelf;
    if (self.imageCount != self.sourceImagesContainerView.subviews.count) {
...
- (void)show
{
//    FindViewControlller *find = [[FindViewControlller alloc]init];
//    FindViewController *fin = [FindViewController new];
//    fin.window.hidden = YES;
...
- (void)showFirstImage
{
    ...
    UIView *sourceView = [self.sourceImagesContainerView.subviews objectAtIndex:self.currentImageIndex];
